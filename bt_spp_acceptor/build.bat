...
GitWCRev . ./version_bin.fmt ./version.txt
@echo off
...
set oldBinaryFileName=".\build\bt_spp_acceptor_demo.bin"
set newBinaryFileName=".\build\bt_spp_acceptor_demo_v%ver%.bin"
copy /Y %oldBinaryFileName% %newBinaryFileName%
if NOT ERRORLEVEL 1 (echo %newBinaryFileName%)